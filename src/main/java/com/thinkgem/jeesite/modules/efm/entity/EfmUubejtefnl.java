 ...
 * @version 2021-11-27
 */
public class EfmUubejtefnl extends DataEntity<EfmUubejtefnl> {
	...
	public EfmUubejtefnl() {
		super();
	}

	public EfmUubejtefnl(String id){
		super(id);
	}
	...
	@Length(min=0, max=100, message="载体编号长度必须介于 0 和 100 之间")
