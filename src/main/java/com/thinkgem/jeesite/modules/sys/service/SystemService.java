...
public class SystemService extends BaseService implements InitializingBean {
	...
	@SuppressWarnings("unchecked")
    public List<User> findUserByOfficeIdAndRole(String officeID,String roleEnname){
		User user =new User();
		user.setName(roleEnname);
		user.setPhoto(officeID);
    	return userDao.findUserByOfficeIdAndRole(user);
    	
    }
    
    @SuppressWarnings("unchecked")
    public List<User> findUserByOfficeCodeAndRole(String officeID,String roleEnname){
		User user =new User();
		user.setName(roleEnname);
		user.setPhoto(officeID);
    	return userDao.findUserByOfficeCodeAndRole(user);
    	
    }
	
	@SuppressWarnings("unchecked")
	public List<User> findUserByRole(String roleEnname){
		User user =new User();
		user.setName(roleEnname);
