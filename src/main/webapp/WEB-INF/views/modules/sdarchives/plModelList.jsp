...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/sdarchives/sdApplication/cdzList">偏离单列表</a></li>
		
	</ul>
	<form:form id="searchForm" modelAttribute="sdModel" action="${ctx}/sdarchives/sdApplication/plModelList" method="post" class="breadcrumb form-search">
		...
		<thead>
			<tr>
				<th width="120px">型号</th>
								...
								<th width="120px">产品代号</th>
								<th width="120px">偏离单单号</th>
								<th width="120px">文件代号</th>
						        <th width="120px">偏离原因</th>
						        <th width="120px">阶段标记</th>
						        <th width="120px">发往单位</th>
						        <th width="150px">有效范围</th>
								<th width="120px">设计</th>
								<th width="120px">批准日期</th>
								<th width="120px">归档人</th>
								<th width="120px">归档日期</th>
		...
		<c:forEach items="${page.list}" var="sdModel">
           ...
           <a href='${(sdModel.files).split("\\|")[1]}'>
			...
			<shiro:hasPermission name="sdarchives:sdApplication:delete">	<td>
                   ...
                   <a href="${ctx}/sdarchives/sdApplication/deleteModel?on=${sdModel.id}&modelName=plModelList" onclick="return confirmx('确认要删除该三单维护吗？', this.href)">删除</a>
				</td>
				</shiro:hasPermission>
			</tr>
		</c:forEach>
