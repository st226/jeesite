...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sdarchives/sdApplication/plList">偏离单维护列表</a></li>
		<li class="active"><a href="${ctx}/sdarchives/sdApplication/form?id=${sdApplication.id}">偏离单维护<shiro:hasPermission name="sdarchives:sdApplication:edit">${not empty sdApplication.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sdarchives:sdApplication:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
					...
					<script type="text/template" id="sdModelTpl">//<!--
						<tr id="sdModelList{{idx}}">
							<td class="hide">
                             ...
                             <td>
								<input id="sdModelList{{idx}}_gdrname" name="sdModelList[{{idx}}].gdrname" type="text"  style="width:100px"  value="{{row.gdrname}}" maxlength="200" class="input-small "/>
							</td>
							<td>
							...
							<td>
                             ...
                             <td>
								<input id="sdModelList{{idx}}_plyy" name="sdModelList[{{idx}}].plyy" type="text"  style="width:100px"  value="{{row.plyy}}" maxlength="255" class="input-small "/>
							</td>
							<td>
								<select id="sdModelList{{idx}}_bjjd" name="sdModelList[{{idx}}].bjjd" data-value="{{row.bjjd}}" class="input-small ">
									<option value=""></option>
							...
							<td>
								<input id="sdModelList{{idx}}_yxfw" name="sdModelList[{{idx}}].yxfw" type="text"   style="width:100px"  value="{{row.yxfw}}" maxlength="500" class="input-small "/>
							</td>
							<td>
