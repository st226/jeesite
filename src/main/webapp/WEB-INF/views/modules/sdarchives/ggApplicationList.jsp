...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="sdarchives:sdApplication:edit"><li><a href="${ctx}/sdarchives/sdApplication/ggform">更改单添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="sdApplication" action="${ctx}/sdarchives/sdApplication/ggList" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="sdApplication">
			<tr>
				<td><a href="${ctx}/sdarchives/sdApplication/ggform?id=${sdApplication.id}">
				...
				<shiro:hasPermission name="sdarchives:sdApplication:edit"><td>
    				<a href="${ctx}/sdarchives/sdApplication/ggform?id=${sdApplication.id}">修改</a>
