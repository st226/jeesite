...
<head>
	...
	<script type="text/javascript">
		...
		function rkReceive(){
            ...
            //入库的提交操作
            if(flag==1){
            //  	window.open("${ctx}/business/receive/swReceive/rkReceive?ids="+ids,'top'); 
            	window.location.href="${ctx}/business/receive/swReceive/rkReceive?ids="+ids ;
           
            	
         //   	top.$.jBox.open("iframe:${ctx}/business/receive/swReceive/rkReceive?ids="+ids,"设备入库", 900, 500, {
       ...
       //            type: 'POST',
		...
		function ckReceive(){
            ...
            if(flag==1){
            	   ...
            	   window.location.href="${ctx}/business/receive/swReceive/ckReceive?ids="+ids ;
		...
		function wcReceive(){
			 ...
			 window.location.href= "${ctx}/business/receive/swReceive/wcEquipment?orderId=${orderId}";
		}
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/business/receive/SwReceiveEquipment/form">入库/出库</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="SwReceive" method="post" action="${ctx}/business/receive/swReceive/listEquipment/?orderId=${orderId}" class="breadcrumb form-search">
		...
		<li class="btns"><input id="rkSubmit" class="btn btn-primary" type="button" value="入 库"/></li>
		<li class="btns"><input id="ckSubmit" class="btn btn-primary" type="button" value="出 库"/></li>
		<li class="btns"><input onclick="wcReceive()" class="btn btn-primary" type="button" value="完 成"/></li>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="swReceiveEquipment" varStatus="vs">
			<tr>
				...
				<td>
    				<a target="_blank" href="${ctx}/business/receive/swReceive/viewEquipment?ids=${swReceiveEquipment.id}">出库</a>
    			</td>
			</tr>
		</c:forEach>
		</tbody>
