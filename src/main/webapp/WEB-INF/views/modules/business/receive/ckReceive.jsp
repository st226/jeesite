...
<body>
	...
	<form:form id="inputForm" modelAttribute="swReceiveEquipment" action="${ctx}/business/receive/swReceive/cksave" method="post" class="form-horizontal">
	...
	<table  border='1' bordercolor='#000000' style='border-collapse:collapse;width: 820px;margin-left: 36px;margin-right:56px;margin-top:26px;'>
		<caption align="top"  style="font-size: 28px;margin-bottom: 10px;line-height:150%" ><b>设备出库</b></caption>
		...
		<tr>
				...
				<tr>
				   <td height="100px" style='vertical-align:middle; text-align:center;font-family: 黑体, SimHei; '  colspan="3">部门设备管理员意见</td>
				    <td colspan="9"  style='vertical-align:bottom; text-align:right;font-family: 黑体, SimHei; ' >
					签名：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</td>
				</tr>
				<tr>
				   <td height="100px" style='vertical-align:middle; text-align:center;font-family: 黑体, SimHei; '  colspan="3">责任人意见</td>
				    <td colspan="9"  style='vertical-align:bottom; text-align:right;font-family: 黑体, SimHei; ' >
					签名：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</td>
				</tr>
	...
	<tr id="rkfiles" >
					<td width="24%" style='vertical-align:middle; text-align:center;font-family: 黑体, SimHei; ' >上传出库申请：</td>
					<td  width="72%" >
							<form:hidden id="cfiles" path="cfiles" htmlEscape="false" maxlength="2000" class="input-xlarge"/>
				<sys:ckfinder input="cfiles" type="files" uploadPath="/business/receive" selectMultiple="true"/>
