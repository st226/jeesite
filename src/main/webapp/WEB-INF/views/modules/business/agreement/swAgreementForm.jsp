...
<body>
	...
	<form:form id="inputForm" modelAttribute="swAgreement" action="${ctx}/business/agreement/swAgreement/save" method="post" class="form-horizontal">
		...
		<table class="table-form">
				<tr>
					<td class="tit" width="15%">合同编号：</td><td width="35%">
						<form:input path="agreementNo" htmlEscape="false" maxlength="255"  class="input-xlarge " readonly="true"/>
				...
				<sys:ckfinder input="file" type="files" uploadPath="/business/agreement/swAgreement" selectMultiple="true"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="business:agreement:swAgreement:edit">
			<input id="btnSubmit" class="btn btn-primary" type="button" value="暂 存"  onclick="oksave(1)" />&nbsp;</shiro:hasPermission>
