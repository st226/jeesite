...
<body>
	<ul class="nav nav-tabs">
	    ...
	    <li class="active"><a href="${ctx}/business/order/swOrder/listProductYear">采购进度</a></li>
	
	</ul>
	<form:form id="searchForm" modelAttribute="swOrder" action="${ctx}/business/order/swOrder/listProductYear" method="post" class="breadcrumb form-search">
