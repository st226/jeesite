...
<body>
	...
	<form:form id="inputForm" modelAttribute="swPurchase" action="${ctx}/business/purchase/swPurchase/save" method="post" class="form-horizontal">
		...
		<table class="table-form">
				...
				<sys:ckfinder input="file" type="files" uploadPath="/business/purchase/swPurchase" selectMultiple="true"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="business:purchase:swPurchase:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="暂 存"/>&nbsp;</shiro:hasPermission>
