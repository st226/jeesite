	...
	<script type="text/javascript">
		...
		function delRow(obj, prefix){
		 ...
		 function sunt(){
			 ...
			 $("#negotiateNotes").val('客户报价'+$("#totalPrice").val()+'元，经谈判在保证产品功能和产品服务的前提下，最终价格'+$("#negotiatePrice").val());
		 }
	</script>
</head>
<body>
	...
	<form:form id="inputForm" modelAttribute="swNegotiate" action="${ctx}/business/negotiate/swNegotiate/save" method="post" class="form-horizontal">
			...
			<table class="table-form">
				<tr>
					...
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false});"/>
						...
						<form:input path="negotiateLocal" htmlEscape="false" maxlength="50" class="input-xlarge"/>
				...
				<sys:ckfinder input="appendix" type="files" uploadPath="/business/negotiate/swNegotiate" selectMultiple="true"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="business:negotiate:swNegotiate:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="暂 存"/>&nbsp;</shiro:hasPermission>
