...
function tt(id){
	 var id = $("#id").val();
			...
			window.open("${ctx}/business/special/swSpecial/view?id=${swSpecial.id}",'top'); 
		}
function plus(){
...
<body>
	...
	<form:form id="inputForm" modelAttribute="swSpecial" action="${ctx}/business/special/swSpecial/save" method="post" class="form-horizontal">
		...
		<table class="table-form">
				...
				<span class="help-inline"><font color="red">*</font> </span>
					</td><td class="tit" width="15%">采购情况类型：</td><td width="35%">
				...
				<sys:ckfinder input="file" type="files" uploadPath="/business/special/swSpecial" selectMultiple="true"/>
