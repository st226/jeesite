...
<body>
	...
	<form:form id="inputForm" modelAttribute="swSurvey" action="${ctx}/business/survey/swSurvey/save" method="post" class="form-horizontal">
		...
		<table class="table-form">
		        <tr >
					<td class="tit" width="15%">公司统一编号：</td><td width="35%" colspan="3">
							<form:input path="field4" htmlEscape="false" maxlength="255" class="input-xxlarge"/>
		 ...
		 <legend>调研厂家</legend>
					...
					<table id="contentTable" class="table table-striped table-bordered table-condensed">
						<thead>
							<tr>
								...
								<shiro:hasPermission name="business:survey:swSurvey:edit"><th width="10">&nbsp;</th></shiro:hasPermission>
							</tr>
						</thead>
						<tbody id="swSurveyCompanyList">
						</tbody>
						<shiro:hasPermission name="business:survey:swSurvey:edit"><tfoot>
							<tr><td colspan="14"><a href="javascript:" onclick="newRow('#swSurveyCompanyList', swSurveyCompanyRowIdx, swSurveyCompanyTpl);swSurveyCompanyRowIdx = swSurveyCompanyRowIdx + 1;" class="btn">新增</a></td></tr>
					...
					<script type="text/template" id="swSurveyCompanyTpl">//<!--
						<tr id="swSurveyCompanyList{{idx}}">
							...
							<td>
								<input id="swSurveyCompanyList{{idx}}_field2" name="swSurveyCompanyList[{{idx}}].field2" type="text" value="{{row.field2}}" maxlength="255" class="input-small "/>
							</td>

                            <td>
								<select id="swSurveyCompanyList{{idx}}_field3" name="swSurveyCompanyList[{{idx}}].field3" data-value="{{row.field3}}" class="input-small ">
									<option value=""></option>
									<c:forEach items="${fns:getDictList('survey_class')}" var="dict">
							...
							<shiro:hasPermission name="business:survey:swSurvey:edit"><td class="text-center" width="10">
								{{#delBtn}}<span class="close" onclick="delRow(this, '#swSurveyCompanyList{{idx}}')" title="删除">&times;</span>{{/delBtn}}
		...
		<table class="table-form">
				...
				<sys:ckfinder input="resolutionFile" type="files" uploadPath="/business/survey/swSurvey" selectMultiple="true"/>
		       ...
		       <tr>
				...
				<sys:ckfinder input="resolutionResult" type="files" uploadPath="/business/survey/swSurvey" selectMultiple="true"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="business:survey:swSurvey:edit">
