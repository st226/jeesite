...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/business/bidding/swBidding/form?id=${swBidding.id}">内部招投标<shiro:hasPermission name="business:bidding:swBidding:edit">${not empty swBidding.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="business:bidding:swBidding:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	...
	<form:form id="inputForm" modelAttribute="swBidding" action="${ctx}/business/bidding/swBidding/save" method="post" class="form-horizontal">
		...
		<table class="table-form">
               ...
               <tr>	
				...
				<sys:ckfinder input="file" type="files" uploadPath="/business/bidding/swBidding" selectMultiple="true"/>
					</td>
					</tr>	
		</table>
				 ...
				 <legend>供应商</legend>
					...
					<table id="contentTable" class="table table-striped table-bordered table-condensed">
						...
						<shiro:hasPermission name="business:bidding:swBidding:edit"><tfoot>
							<tr><td colspan="17"><a href="javascript:" onclick="addRow('#swBiddingSupplierList', swBiddingSupplierRowIdx, swBiddingSupplierTpl);swBiddingSupplierRowIdx = swBiddingSupplierRowIdx + 1;" class="btn">新增</a></td></tr>
		...
		<div id="plusDiv" style="display: block">
		 <table class="table-form">
				...
				<sys:ckfinder input="signFile" type="files" uploadPath="/business/bidding/swBidding" selectMultiple="true"/>
					</td>
				...
				<sys:ckfinder input="notice" type="files" uploadPath="/business/bidding/swBidding" selectMultiple="true"/>
					</td>
		...
		<div class="form-actions">
			...
			<shiro:hasPermission name="business:bidding:swBidding:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="暂 存"/>&nbsp;</shiro:hasPermission>
