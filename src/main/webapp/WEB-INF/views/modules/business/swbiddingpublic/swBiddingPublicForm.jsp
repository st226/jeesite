	...
	<form:form id="inputForm" modelAttribute="swBiddingPublic" action="${ctx}/business/swbiddingpublic/swBiddingPublic/save" method="post" class="form-horizontal">
		...
		<table class="table-form">	
			...
			<tr>
				...
				<sys:ckfinder input="specialFile" type="files" uploadPath="/business/survey/swSurvey" selectMultiple="true"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="business:swbiddingpublic:swBiddingPublic:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="暂 存"/>&nbsp;</shiro:hasPermission>
