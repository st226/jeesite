		...
		<tr>
					...
					<script type="text/template" id="sbBorrowChildTpl">//<!--
						<tr id="sbBorrowChildList{{idx}}">
							...
							<td>
                                {{row.equipmentName}}
								<input id="sbBorrowChildList{{idx}}_equipmentName" name="sbBorrowChildList[{{idx}}].equipmentName" type="hidden" value="{{row.equipmentName}}" maxlength="199" class="input-mini "/>
							</td>
							<td>{{row.equipmentType}}
								<input id="sbBorrowChildList{{idx}}_equipmentType" name="sbBorrowChildList[{{idx}}].equipmentType" type="hidden" value="{{row.equipmentType}}" maxlength="199" class="input-mini "/>
							</td>
							...
							<td>{{row.measurement}}
								<input id="sbBorrowChildList{{idx}}_measurement" pattern="yyyy-MM-dd" name="sbBorrowChildList[{{idx}}].measurement" type="hidden" readonly="readonly" maxlength="20" class="input-mini Wdate "
