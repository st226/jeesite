								...
								<div class="row">
									...
									<div class="col-sm-7 infobox-container">
										...
										<div class="infobox infobox-green">
											...
											<div class="infobox-data">
												<span class="infobox-data-number">800000</span>
												<div class="infobox-content">图书</div>
											</div>
										</div>
										...
										<div class="infobox infobox-blue">
											...
											<div class="infobox-data">
												<span class="infobox-data-number">2300</span>
												<div class="infobox-content">专利</div>
											</div>
										...
										<div class="infobox infobox-pink">
											...
											<div class="infobox-data">
												<span class="infobox-data-number">2123</span>
												<div class="infobox-content">会议</div>
											</div>
										...
										<div class="infobox infobox-red">
											...
											<div class="infobox-data">
												<span class="infobox-data-number">1234</span>
										...
										<div class="infobox infobox-orange2">
											...
											<div class="infobox-data">
												<span class="infobox-data-number">2300</span>
												<div class="infobox-content">标准</div>
											</div>
										...
										<div class="infobox infobox-blue2">
											...
											<div class="infobox-data">
												<span class="infobox-data-number">3300</span>
												<div class="infobox-content">硕博论文</div>
											</div>
										</div>
									...
									<!-- /section:pages/dashboard.infobox -->
										...
										<div class="infobox infobox-green infobox-small infobox-dark">
											...
											<div class="infobox-data">
												<div class="infobox-content">新书推荐</div>
												<div class="infobox-content">6000</div>
											</div>
										</div>
										...
										<div class="infobox infobox-blue infobox-small infobox-dark">
											...
											<!-- /section:pages/dashboard.infobox.sparkline -->
											<div class="infobox-data">
												<div class="infobox-content">预约服务</div>
											</div>
										</div>
										...
										<div class="infobox infobox-grey infobox-small infobox-dark">
											...
											<div class="infobox-data">
												<div class="infobox-content">通知</div>
												...
												<div class="widget-main">
													...
													<div class="clearfix">
														...
														<div class="grid3">
															...
															<h4 class="bigger pull-right">80,000</h4>
														</div>
												...
												<div class="widget-main no-padding">
													<table class="table table-bordered table-striped">
														<thead class="thin-border-bottom">
															<tr>
																<th>
																	<i class="ace-icon fa fa-caret-right blue"></i>资源名称
																</th>
																...
																<th class="hidden-480">
																	<i class="ace-icon fa fa-caret-right blue"></i>是否可借阅
																</th>
															</tr>
														</thead>
														...
														<div id="member-tab" class="tab-pane">
															...
															<div class="clearfix">
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Bob Doe's avatar" src="${ctxStatic}/assets/avatars/user.jpg" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Joe Doe's avatar" src="${ctxStatic}/assets/avatars/avatar2.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Jim Doe's avatar" src="${ctxStatic}/assets/avatars/avatar.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Alex Doe's avatar" src="${ctxStatic}/assets/avatars/avatar5.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Bob Doe's avatar" src="${ctxStatic}/assets/avatars/avatar2.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Susan's avatar" src="${ctxStatic}/assets/avatars/avatar3.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Phil Doe's avatar" src="${ctxStatic}/assets/avatars/avatar4.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Alexa Doe's avatar" src="${ctxStatic}/assets/avatars/avatar1.png" />
																	</div>
														...
														<div id="comment-tab" class="tab-pane">
															...
															<div class="comments">
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Bob Doe's Avatar" src="${ctxStatic}/assets/avatars/avatar.png" />
																	</div>
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Jennifer's Avatar" src="${ctxStatic}/assets/avatars/avatar1.png" />
																	</div>
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Joe's Avatar" src="${ctxStatic}/assets/avatars/avatar2.png" />
																	</div>
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Rita's Avatar" src="${ctxStatic}/assets/avatars/avatar3.png" />
																	</div>
												...
												<div class="widget-main no-padding">
													...
													<div class="dialogs">
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Alexa's Avatar" src="${ctxStatic}/assets/avatars/avatar1.png" />
															</div>
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="John's Avatar" src="${ctxStatic}/assets/avatars/avatar.png" />
															</div>
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Bob's Avatar" src="${ctxStatic}/assets/avatars/user.jpg" />
															</div>
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Jim's Avatar" src="${ctxStatic}/assets/avatars/avatar4.png" />
															</div>
