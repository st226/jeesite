...
<head>
	...
	<script type="text/javascript">
		...
		function submit1(){
			...
			$.ajax({
                type:'post',
                url:'${ctx}/archives/application/updateFiles',
                data:{'id':'${model.id}','atlasPid':'${model.atlasPid}','files':$(files).val()},
                cache:false,
                dataType:'json',
...
<body>
	<br/>
	<form:form id="inputForm" modelAttribute="model" action="${ctx}/archives/application/updateFiles" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<form:hidden path="atlasPid"/>
