	...
	<form:form id="inputForm" modelAttribute="tsApprover" action="${ctx}/approver/tsApprover/submit" method="post" class="form-horizontal">
		...
		<legend >${tsApprover.workItem.workItemName}</legend>
			<table class="table-form">
				...
				<tr>
				<td class="tit">题名：</td><td>
						${tsApprover.name}
				
					</td>
				<td class="tit">文件：</td><td>
						<form:hidden id="file" path="file"   htmlEscape="true" maxlength="255" class="required"/>
			       <sys:ckfinder input="file"  type="file" uploadPath="/oa/notify"  selectMultiple="true"  readonly="true"  />
			...
			<tr>
				...
				<tr>
					...
					<td colspan="6">
						<form:textarea path="username" class="required" rows="5" maxlength="20" cssStyle="width:500px"/>
					</td>
				</tr></table>
