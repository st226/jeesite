...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/equipment/event/sbEvent/form?id=${sbEvent.id}">设备转借<shiro:hasPermission name="equipment:event:sbEvent:edit">${not empty sbEvent.id?'修改':''}</shiro:hasPermission><shiro:lacksPermission name="equipment:event:sbEvent:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="sbEvent" action="${ctx}/equipment/event/sbEvent/saveLending" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<form:hidden path="processinstid"/>
		<form:hidden path="state"/>
		<form:hidden path="type" value='lending'/>
		<sys:message content="${message}"/>		
		
	
		<div class="control-group">
			<label class="control-label">转借部门：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">转借人：</label>
			<div class="controls">
