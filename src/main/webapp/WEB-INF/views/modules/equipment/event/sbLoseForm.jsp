...
<body>
	...
	<form:form id="inputForm" modelAttribute="sbEvent" action="${ctx}/equipment/event/sbEvent/saveLose" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<form:hidden path="processinstid"/>
		<form:hidden path="state"/>
		<form:hidden path="type" value='lose'/>
