...
<body>
	...
	<form:form id="inputForm" modelAttribute="sbEvent" action="${ctx}/equipment/event/sbEvent/submitLose" method="post" class="form-horizontal">
		<form:hidden path="id"/>
	    ...
	    <fieldset>
		    ...
		    <table class="table-form">
				...
				<tr>
					<td class="tit">说明：</td><td colspan="3">
					${sbEvent.cause}
