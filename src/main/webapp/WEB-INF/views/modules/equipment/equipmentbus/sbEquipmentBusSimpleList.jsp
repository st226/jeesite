...
<head>
	...
	<script type="text/javascript">
		...
		function gjcx(){
			  ...
			  window.location.href= "${ctx}/equipment/equipmentbus/sbEquipmentBus/seoList";
		}
	</script>
	<style type="text/css">
...
<body>
	...
	<form:form id="searchForm" modelAttribute="sbEquipment" action="${ctx}/equipment/equipmentbus/sbEquipmentBus/simpleList?fsType=${fsType}" method="post" class="breadcrumb form-search">
