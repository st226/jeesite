...
<head>
	...
	<script type="text/javascript">
		...
		function metering(){
			window.location =  "${ctx}/equipment/metering/sbMetering/formMonth";
		}
...
<body>
	...
	<form:form id="searchForm" modelAttribute="sbEquipment" action="${ctx}/equipment/equipmentbus/sbEquipmentBus/meteringMonthList" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li class="btns"><input id="jlSubmit" class="btn btn-primary" type="button" value="全部计量"/></li>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="maps"  varStatus="vs">
			...
			<td>
    				<a style='cursor:pointer' onclick='tt("${maps.id}")'><i class="icon-shopping-cart"></i>计量</a>
				</td>
			</tr>
		</c:forEach>
		</tbody>
