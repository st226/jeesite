...
<head>
	...
	<script type="text/javascript">
		...
		function zz(id){
			 var url = "iframe:${ctx}/metering/meteringnotify/sbMeteringNotify/form?equipmentId="+id;
			 top.$.jBox.open(url,"计量追踪单", 900, 460, {
   	            ...
   	            submit:function(v, h, f){
   	                ...
   	                if(v=="ok"){
	                     ...
	                     var url = "${ctx}/metering/meteringnotify/sbMeteringNotify/saveNotify";
	                    $.ajax({
	                        type: 'POST',
	                        url : url,
	                        async:false,
...
<body>
	...
	<form:form id="searchForm" modelAttribute="sbEquipment" action="${ctx}/equipment/equipmentbus/sbEquipmentBus/meteringList" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="maps"  varStatus="vs">
			...
			<td>
    			...
    			&nbsp;<a style='cursor:pointer' onclick='zz("${maps.id}")'>${maps.bstate=='1'?'<i class="icon-paper-clip"></i>追踪':''}</a>
				</td>
			</tr>
		</c:forEach>
		</tbody>
