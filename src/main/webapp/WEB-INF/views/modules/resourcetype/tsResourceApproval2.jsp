...
<body>
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/resourcebus/tsResourceBus/">现行文件归档列表</a></li>
	...
	<form:form id="inputForm" modelAttribute="genTable" action="${ctx}/resourcebus/tsResourceBus/savegd2" method="post" class="form-horizontal">
