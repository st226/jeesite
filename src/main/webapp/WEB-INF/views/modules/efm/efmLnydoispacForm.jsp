...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/efm/efmLnydoispac/">涉密载体归档管理列表</a></li>
		<li class="active"><a href="${ctx}/efm/efmLnydoispac/form?id=${efmLnydoispac.id}">涉密载体归档管理<shiro:hasPermission name="efm:efmLnydoispac:edit">${not empty efmLnydoispac.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="efm:efmLnydoispac:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="efmLnydoispac" action="${ctx}/efm/efmLnydoispac/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="efm:efmLnydoispac:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
