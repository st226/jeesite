...
<head>
	...
	<script type="text/javascript">
		...
		function ok(e){
			...
			if( $("#field3Id").val()==null || $("#field3Id").val()=="" ){
				alert("请先选择审批人");
			}else{
				$("#state").val("1");
			    $("#inputForm").submit();
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/quality/qmsupplier/qmSupplier/form?id=${qmSupplier.id}">供应商管理<shiro:hasPermission name="quality:qmsupplier:qmSupplier:edit">${not empty qmSupplier.id?'变更':'申请'}</shiro:hasPermission><shiro:lacksPermission name="quality:qmsupplier:qmSupplier:edit">查看</shiro:lacksPermission></a></li>
	</ul>
	<form:form id="inputForm" modelAttribute="qmSupplier" action="${ctx}/quality/qmsupplier/qmSupplier/saveApply" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table-form">
				...
				<tr>
					...
					<td class="tit" width="15%">设计或工艺：</td><td width="35%"  colspan="3">
						<sys:treeselect id="field3" name="field3" value="${qmSupplier.field3}" labelName="field4" labelValue="${qmSupplier.field4}"
					title="用户" url="/sys/office/treeData?type=3" cssClass="" allowClear="true" notAllowSelectParent="true"/>
				<span class="help-inline">选择设计或工艺人员，用于产品试验验证 </span>
					</td>
				<!-- 	<td class="tit" width="15%">主管部门领导：</td><td width="35%">
						<sys:treeselect id="field5" name="field5" value="${swOrder.field5}" labelName="field6" labelValue="${swOrder.field6}"
					title="用户" url="/sys/office/treeData?type=3" cssClass="" allowClear="true" notAllowSelectParent="true"/>
				<span class="help-inline">用于主管部门审核 </span>
					</td> -->
