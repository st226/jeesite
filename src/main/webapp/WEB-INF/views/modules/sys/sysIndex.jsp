...
<head>
	...
	<style type="text/css">
		...
		.logo {float:left; margin:-20px 20px 0 0px; _margin-left:10px; _margin-right:10px; width:60px; height:40px; background:url(${ctxStatic}/login/img/logo.png) no-repeat; _background:url(${ctxStatic}/login/img/logo.png) no-repeat;}
		.suntao
    { padding-right: 9px;
    padding-left: 9px;
    border-radius: 9px;
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">   
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right">
				     <li><a  target="mainFrame" href="${ctx}/act/task/todo/"  title="待办任务"><i class="icon-bell"></i><span class="suntao" id="notifyNum3" ></span></a></li>
					...
					<li id="userInfo" class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="${ctx}/act/task/todo/" target="mainFrame"><i class="icon-bell"></i>&nbsp;  我的任务 <span id="notifyNum2" class="label label-info hide"></span></a></li>
						</ul>
					</li>
				...
				<div class="nav-collapse" style="width: window.outerWidth-500px;">
					<ul id="menu" class="nav" style="*white-space:nowrap;float:none;">
						...
						<li class="menu" ><i class="icon-th-large"></i></li>--%>
					</ul>
				</div><!--/.nav-collapse -->
			</div>
	    </div>
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2012-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="http://lcyx.com" target="_blank">lcyx</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
